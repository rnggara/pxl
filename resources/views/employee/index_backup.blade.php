                    ...
                    @foreach($employees as $key => $value)
                        @if($value->company_id == \Session::get('company_id'))
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">{{$value->emp_position}}</td>
                                <td nowrap="nowrap">
                                    @if(!is_file(public_path('hrd\\uploads\\').$value->contract))
                                        <center>
                                ...
                                <td class="text-center" nowrap="nowrap">
                                    <a href="#{{$value->id}}" class="btn btn-success btn-sm"><i class="fa fa-cog icon-nm"></i> manage</a>
                                </td>
                                <td class="text-center" nowrap="nowrap">
                                    <a href="#{{$value->id}}" class="btn btn-success btn-sm"><i class="fa fa-cog icon-nm"></i> manage</a>
                                </td>
                                <td nowrap="nowrap">
                                    <a href="#{{$value->id}}" class="btn btn-sm btn-danger" onclick="return confirm('Pegawai ini DIPECAT?'); "><i class="fa fa-times icon-nm"></i> Fired</a>
                                </td>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="emp_type" name="emp_type" required>
                                        ...
                                        <option value="whbin">Warehouse Bintaro</option>
                                        <option value="whcil">Warehouse Cileungsi</option>
                                        <option value="manager">Manager</option>
                                        <option value="bod">BOD</option>
                                        <option value="konsultan">Konsultan</option>
                                        <option value="local">Local Crew</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">Field Bonus</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="fld_bonus" id="fld_bonus" placeholder="" value="0">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">ODO Bonus</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="odo_bonus" id="odo_bonus" placeholder="" value="0">
                                        <input type="hidden" class="form-control" name="odo_rate" id="odo_rate">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label">WH Bonus</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="wh_bonus" id="wh_bonus" placeholder="" value="0">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Meal</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_meal" id="dom_meal" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_meal" id="ovs_meal" placeholder="">
                                    </div>
                                    <div id="breakdown"></div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Spending</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_spending" id="dom_spending" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_spending" id="ovs_spending" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Overnight</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_overnight" id="dom_overnight" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_overnight" id="ovs_overnight" placeholder="">
                                    </div>
                                </div>
                                <br>
                                <br>
                                <br>
                                <h4>Local Transport</h4><hr>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Airport</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_transport_airport" id="dom_transport_airport" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_transport_airport" id="ovs_transport_airport" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Train</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_transport_train" id="dom_transport_train" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_transport_train" id="ovs_transport_train" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Bus</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_transport_bus" id="dom_transport_bus" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_transport_bus" id="ovs_transport_bus" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">WH Cileungsi</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="dom_transport_cil" id="dom_transport_cil" placeholder="">
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" name="ovs_transport_cil" id="ovs_transport_cil" placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
