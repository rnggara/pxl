                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <b>Division Approval</b><br>
                                        ...
                                        $status = "";
                                        /** @var TYPE_NAME $pev */
                                        if ($pev->fr_division_approved_by == null && $pev->fr_division_rejected_by == null){
                                            $status = "N/A";
                                        } else {
                                            if ($pev->fr_division_approved_by != null){
                                                $status = "<label class='text-success'>Approved</label> by". $pev->fr_division_approved_by." ".date('d M Y', strtotime($pev->fr_division_approved_at));
                                            }
                                            if ($pev->fr_division_rejected_by != null){
                                                $status = "<label class='text-success'>Rejected</label> by". $pev->fr_division_rejected_by." ".date('d M Y', strtotime($pev->fr_division_rejected_at));
                                            }
                                        }
                                        @endphp
                                        ...
                                        $status2 = "";
                                        /** @var TYPE_NAME $pev */
                                        if ($pev->fr_approved_by == null && $pev->fr_rejected_by == null){
                                            $status2 = "N/A";
                                        } else {
                                            if ($pev->fr_approved_by != null){
                                                $status2 = "<label class='text-success'>Approved</label> by". $pev->fr_approved_by." ".date('d M Y', strtotime($pev->fr_approved_at));
                                            }
                                            if ($pev->fr_rejected_by != null){
                                                $status2 = "<label class='text-success'>Rejected</label> by". $pev->fr_rejected_by." ".date('d M Y', strtotime($pev->fr_rejected_at));
                                            }
                                        }
                                        @endphp
                                    ...
                                    <td class="text-center">
                                        ...
                                        @php
                                            $status3 = "";
                                            /** @var TYPE_NAME $pev */
                                            if ($pev->pre_approved_by == null && $pev->pre_rejected_by == null){
                                                $status3 = "N/A";
                                            } else {
                                                if ($pev->pre_approved_by != null){
                                                    $status3 = "<label class='text-success'>Approved</label> by". $pev->pre_approved_by." ".date('d M Y', strtotime($pev->pre_approved_at));
                                                }
                                                if ($pev->pre_rejected_by != null){
                                                    $status3 = "<label class='text-success'>Rejected</label> by". $pev->pre_rejected_by." ".date('d M Y', strtotime($pev->pre_rejected_at));
                                                }
                                            }
                                        @endphp
                                    ...
                                    <td class="text-center">
                                        ...
                                        @php
                                            $status4 = "";
                                            /** @var TYPE_NAME $pev */
                                            if ($pev->pev_approved_by == null && $pev->pev_rejected_by == null){
                                                $status4 = "N/A";
                                            } else {
                                                if ($pev->pev_approved_by != null){
                                                    $status4 = "<label class='text-success'>Approved</label> by". $pev->pev_approved_by." ".date('d M Y', strtotime($pev->pev_approved_at));
                                                }
                                                if ($pev->pev_rejected_by != null){
                                                    $status4 = "<label class='text-success'>Rejected</label> by". $pev->pev_rejected_by." ".date('d M Y', strtotime($pev->pev_rejected_at));
                                                }
                                            }
                                        @endphp
                    ...
                    <div class="row">
                        ...
                        <table class="text-white font-size-sm">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    {{(isset($pro[$pev->project]))?$pro[$pev->project]:''}}
                                </td>
                            </tr>
                            <tr>
                                <td>Note</td>
                    ...
                    <table class="table display table-responsive-xl table-bordered">
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                ...
                                <td class="text-center">
                                    <input type="text" onchange="sum_calc('{{$i}}')" value="{{(is_array(json_decode($pev->discs)))?(!empty(json_decode($pev->discs)[$i])) ? json_decode($pev->discs)[$i] : 0 : 0}}" min="0" name="discount[{{$i}}]" id="discount_{{$i}}" class="form-control number">
                        ...
                        <tr>
                            ...
                            @for($i=0; $i<3; $i++)
                                ...
                                <td class="text-center">
                                    <input type="text" value="0" id="g_total_{{$i}}" class="form-control">
                                </td>
                            @endfor
                        </tr>
                        <tr>
