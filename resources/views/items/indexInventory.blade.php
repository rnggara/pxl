                ...
                @actionStart('inventory', 'read')
                    @foreach($items as $key => $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('itemsInventory.detail', $item->id) }}">{{ $item->name }}</a>
                            </td>
                            <td>{{$item->catName}}</td>
                            ...
                            <td align="center">
                                <span class="label label-inline label-primary">
                                    {{ (isset($qtyWh[$item->id])) ? array_sum($qtyWh[$item->id]) : 0 }}
                                </span>
                            </td>
                            ...
                            <td align="center">
                                <a href="{{ route('barcode.generate', $item->id) }}" class="btn btn-sm btn-primary">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                @foreach($warehouses as $key => $value)
                                    <div class="form-group row" id="whdiv{{$value->id}}">
