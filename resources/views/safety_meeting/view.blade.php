    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{route('sm.index')}}" class="btn btn-xs btn-secondary"><i class="fa fa-backspace"></i> Back</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="modal fade" id="addMOM" tabindex="-1" role="dialog" aria-labelledby="addMOM" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add Safety Meeting</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <i aria-hidden="true" class="ki ki-close"></i>
                                    </button>
                                </div>
                                <form method="post" id="form-add" action="{{route('sm.detail.storeMOM')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#kt_datatable1a').DataTable({
                'ajax':'{{route('sm.getAbsence',['id' => $id_main])}}',
                'type' : 'GET',
            ...
            $('#kt_datatable1b').DataTable({
                'ajax':'{{route('sm.getMom',['id' => $id_main])}}',
                'type' : 'GET',
                dataSrc: 'responseData',
