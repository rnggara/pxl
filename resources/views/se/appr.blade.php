                                ...
                                @for($i=0; $i<3; $i++)
                                    <td class="text-center">
                                        <div class="radio-inline">
                                            ...
                                            <input type="number" {{($i == 0) ? "required" : ""}} step=".01" onchange="calc('{{$item->id}}', '{{$i}}')" name="unit_price[{{$item->id}}][{{$i}}]" id="unit_price_{{$item->id}}_{{$i}}" value="{{(!empty(json_decode($item->unit_price)[$i])) ? json_decode($item->unit_price)[$i] : 0}}" class="form-control">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <?php
