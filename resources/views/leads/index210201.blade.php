        ...
        <div class="card-body">
            ...
            <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <table class="table table-bordered table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;">
                    ...
                    <tr>
                        <th>#</th>
                        <th nowrap="nowrap" class="text-left" >Company Name</th>
                        <th nowrap="nowrap" class="text-center" >Leads Name</th>
                        <th nowrap="nowrap" class="text-center" >Category</th>
                        <th nowrap="nowrap" class="text-center" >Referral</th>
                        <th nowrap="nowrap" class="text-center" >Managed By</th>
                        <th nowrap="nowrap" class="text-center" >Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php $num = 0;  ?>
                        @foreach($leads as $key => $lead)
                            ...
                            <tr>
                                ...
                                <td align="left">{{isset($data_client['client_name'][$lead->id_client]) ? $data_client['client_name'][$lead->id_client] : "N/A"}}</td>
                                ...
                                <td class="text-center">
                                    @if($lead->referral != null)
                                        @foreach(json_decode($lead->referral) as $item)
                                            <div class="mb-2">
                                                <span class="label label-inline label-primary">{{isset($data_user['username'][$item]) ? $data_user['username'][$item] : ""}}</span>
                                            </div>
                                        @endforeach
                                    @else
                                        N/A
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6" id="form-leads">
                                ...
                                <div class="form-group">
                                    <label>Partner</label>
                                    <select name="partner[]" class="form-control select2" id="" multiple>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="referral[]" class="form-control select2" id="" multiple>
