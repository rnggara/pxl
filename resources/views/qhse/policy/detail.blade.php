        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('policy.hse.index')}}" title="Policy Main" class="btn btn-secondary"><i class="fa fa-backspace"></i> Back</a>
                    &nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($value->approved_by == null && $value->approved_time == null)
                                    <a href="{{route('policy.hse.detail.viewappr',['id' => $value->id_detail,'type' => 'appr'])}}" class="btn btn-xs btn-link"><i class="fa fa-search"></i>View & Approve</a>
                                @else
                                    <a href="{{route('policy.hse.detail.viewappr',['id' => $value->id_detail])}}" class="btn btn-xs btn-link"><i class="fa fa-search"></i>View</a>
                                @endif
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="modal fade" id="editEmployee{{$value->id_detail}}" tabindex="-1" role="dialog" aria-labelledby="addEmployee" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="{{route('policy.hse.storeDetail')}}" enctype="multipart/form-data">
                                                @csrf
                                ...
                                <a href="{{route('policy.hse.detail.delete',['id'=>$value->id_detail,'id_main' => $value->id_policy_main])}}" title="Delete" class="btn btn-sm btn-danger btn-icon btn-xs" onclick="return confirm('Delete detail policy?')"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <textarea name="topic" id="topic" class="form-control revise_area" rows="50" cols="10" placeholder="Indonesian version write here.." required>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-3 control-label">Attachment</label>
                                    <div class="col-sm-7">
                                        <input type="file" name="attachment_policy" class="form-control" id="pic_eq" multiple accept='image/*'>
                                    </div>
                                </div>
