                ...
                <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input type="text" class="form-control number" name="amount" required value="{{$val->cashin}}">
                                                                    </div>
                    ...
                    <table class="table table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;" border="0">
                        ...
                        @foreach($typewo as $key => $val)
                            <tr {{ (isset($isCashbond[$val->id]) && !empty($isCashbond[$val->id])) ? "" : "class=print-hide" }}>
                            ...
                            @if ($numRowsOut > 0)
                                ...
                                @if ($sumTc > 0)
                                <tr>
                                    <td colspan="4" class="text-primary">TOTAL {{ $val->name }}</td>
                                    <td align="right">
                                        {{ $detail->currency }} {{ number_format($sumTc, 2) }}
                                    </td>
                                    <td></td>
                                </tr>
                                @endif
