    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="#" class="text-black-50">Slickline</a>
            </div>
                            ...
                            <tbody>
                                @foreach($swt as $key => $value)
                                    <tr>
                                        ...
                                        <td><a href="{{route('te.slickline.items', $value->id)}}" class="label label-inline label-lg label-primary">{{$value->subject}}</a></td>
                                        <td align="center">
    ...
    <div class="modal fade" id="addLeads" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="addProject" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{URL::route('te.slickline.add')}}">
                    @csrf
        ...
        function button_delete(x){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href="{{route('te.slickline.delete')}}/"+x
                }
            })
        }
