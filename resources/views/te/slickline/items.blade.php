    ...
    <div class="modal fade" id="addLeads" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="addProject" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content" id="item-add">
                ...
                <form method="POST" action="{{URL::route('te.slickline.update_items')}}" enctype="multipart/form-data">
                    @csrf
...
@section('custom_script')
    <script>
        ...
        function addItems(x){
            ...
            $.ajax({
                url: "{{route('te.el.items')}}/"+x+"/slickline",
                type: "GET",
                dataType: "json",
                cache: false,
                success: function(response){
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: "{{route('te.slickline.get_items', $swt->id)}}",
                type: "GET",
                dataTpe: "json",
                cache: false,
                success: function(response){
