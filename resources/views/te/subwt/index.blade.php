    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="#" class="text-black-50">Subsurface Welltesting</a>
            </div>
                            ...
                            <tbody>
                                @foreach($swt as $key => $value)
                                    <tr>
                                        ...
                                        <td><a href="{{route('te.subwt.items', $value->id)}}" class="label label-inline label-lg label-primary">{{$value->subject}}</a></td>
                                        <td align="center">
        ...
        function button_delete(x){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href="{{route('te.subwt.delete')}}/"+x
                }
            })
        }
