    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <h3>Instrumentation Item Details</h3><br>

            </div>
            <div class="card-toolbar">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('te.instrument.revision')}}" class="btn btn-warning mr-2"><span class="label label-light-danger mr-2">{{$revisions}}</span> Revision</a>
        ...
        <div class="modal fade" id="addItem" tabindex="-1" role="dialog" aria-labelledby="addEmployee" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{route('te.instrument.store')}}" enctype="multipart/form-data">
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function(){
        $('table.te_instrument').DataTable({
            ...
            'ajax': '{{route('te.instrument.getInstrumentList')}}',
            'type': 'GET',
