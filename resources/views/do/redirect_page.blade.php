					...
					<div class="login-form text-left p-7 position-relative overflow-hidden" style="max-width: 100%">
						...
						<div class="login-signin">
							<div class="mb-20 text-center">
								<h2>{{ ($type == "dispatch") ? "Penugasan selesai." : "Penerimaan barang sukses"  }}</h2>
								<div class="text-muted font-weight-bold font-size-h4">{{ ($type == "dispatch") ? "Kendaraan dapat meneruskan perjalanan" : "Delivery Order $do->no_do sudah berhasil diterima." }}</div>
							</div>
						</div>
