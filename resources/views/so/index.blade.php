                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="so_type" id="so_type" class="form-control select2" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <table class="table table-bordered" id="list_item">
                                        ...
                                        <tr>
                                            <td width="450">
                                                <textarea name="" id="item" class="form-control" placeholder="Job Description" cols="30" rows="10"></textarea>
...
@section('custom_script')
    ...
    <script>
        ...
        function addInput(trName) {
            ...
            var item = tinymce.editors[$("#item").attr('id')].getContent()
            newrow.innerHTML = "<td>" +
                "<input type='hidden' name='name[]' class='input_code' value='" + item + "'><b>" + item + "</b><br />" +
                "</td>" +
                "<td align='center'>" +
            ...
            tinymce.editors[$("#item").attr('id')].setContent(' ')
            $("#qty").val("");
        }
        ...
        function reload_source(x){
            type = x
            var route = "{{ route('sre.list') }}/so/"+type
