    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="attachment-tab" data-toggle="tab" href="#attachment" aria-controls="profile">
                        <span class="nav-icon">
                            <i class="flaticon-file-2"></i>
                        </span>
            ...
            <div class="tab-content mt-5" id="myTabContent">
                                ...
                                <form method="post" id="form-add" action="{{route('mv.detail.storeMOM')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label text-right">Personel</label>
                                                    <div class="col-md-10">
                ...
                <div class="tab-pane fade" id="attachment" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table table-bordered table-hover table-checkable" id="table-attach" style="margin-top: 13px !important">
                        <thead>
                        <tr>
                            <th class="text-center">#</th>
                            <th class="text-center">File</th>
                            <th class="text-center">Download</th>
                            <th class="text-center"><button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#addFile"><i class="fa fa-plus"></i>Add</button></th>
                        </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="symbol mr-3">
                                            <img src="{{ str_replace("public", "public_html", asset($file->attach_pic)) }}" alt="">
                                        </div>
                                    </td>
                                    <td align="center">
                                        <a href="{{ str_replace("public", "public_html", asset($file->attach_pic)) }}" target="_blank" class="btn btn-xs btn-icon btn-light-dark"><i class="fa fa-download"></i></a>
                                    </td>
                                    <td align="center">
                                        <a href="{{ route('mv.detail.deleteAttach', $file->id) }}" class="btn btn-xs btn-icon btn-danger" onclick="return confirm('Delete file?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="modal fade" id="addFile" tabindex="-1" role="dialog" aria-labelledby="addFile" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form method="post" id="form-add" action="{{route('mv.detail.uploadAttach')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label text-right">Upload File</label>
                                                    <div class="col-md-9">
                                                        <div class="custom-file">
                                                            <input type="file" name="file_attach" class="custom-file-input" id="">
