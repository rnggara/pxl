    ...
    <div class="card card-custom gutter-b">
        ...
        <div id='center' align='center'>
            ...
            <table border='1' width='800px'>
                ...
                <tr>
                    <td colspan='3'>
                        <h4>Miss Report : <label class='text-blue'>{{strip_tags($nearmiss->deskripsi)}}</label></h4>
                        <p align='center'>
                            <br />

                        </p>
                        <hr />
                        <h4>Miss Follow-Up :</h4>
                        <p>
                            <img src='{{str_replace('public','public_html',asset('/media/miss_attachment/'))}}/{{$nearmiss->pict_follow}}' alt='picture_ori' style='max-width:400px' />
