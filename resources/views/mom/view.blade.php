                    ...
                    <div class="modal fade" id="addMOM" tabindex="-1" role="dialog" aria-labelledby="addMOM" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                            <div class="modal-content">
                                ...
                                <form method="post" id="form-add" action="{{route('mom.detail.storeMOM')}}">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="minute" class="form-control tmce" rows="5" placeholder="Write Minutes Of Meeting Here . ."></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label text-right">Action</label>
                                                    <div class="col-md-10">
                                                        <textarea name="action" class="form-control tmce" rows="5" placeholder="Write Action Here . ."></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
