    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <a href="javascript:" class="text-black-50">PL VS ACTUAL - <span class="text-primary">{{$pl->year}}</span></a>
            </div>
                        ...
                        @foreach($prognosis as $list)
                            @if($list->category == "sales")
                                <tr>
                                    ...
                                    <td>{{strtoupper($list->subject)}} [{{ $prj[$list->id_project] ?? "" }}]</td>
                        ...
                        @foreach($prognosis as $list)
                            @if($list->category == "cost")
                                <tr>
                                    ...
                                    <td>
                                        {{strtoupper($list->subject)}} <a href="{{route('report.pl.excel', $list->id)}}" download class="btn btn-xs btn-icon btn-success"><i class="fa fa-file-csv"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            $balance = $npbt - $pl->sharing_profit + $total_unpaid;
                            $balance_act = $act_npbt - $pl->sharing_profit + $total_unpaid;

                            $b_treasure = (isset($balance_treasure[$pl->bank_account])) ? array_sum($balance_treasure[$pl->bank_account]) : 0;
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <form action="{{route('report.pl.update', 'share')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 mx-auto">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <input type="text" name="share_profit" class="form-control" value="{{(!empty($pl->sharing_profit)) ? $pl->sharing_profit : 0}}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="hidden" name="id_project" value="{{$pl->id}}">
                                ...
                                <td align="right"><b>{{number_format((!empty($pl->sharing_profit)) ? $pl->sharing_profit : 0, 2)}}</b></td>
                                <td align="right"></td>
                                <td align="right"></td>
                                <td align="right"><b>{{number_format((!empty($pl->sharing_profit)) ? $pl->sharing_profit : 0, 2)}}</b></td>
                                <td align="right"></td>
                            ...
                            <tr>
                                <td align="center">
                                    <b>BANK ACCOUNT</b>
                                    <form action="{{route('report.pl.update', 'bank')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 mx-auto">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <select name="treasure" class="form-control" id="bank">
                                                            ...
                                                            @foreach($treasure as $item)
                                                                <option value="{{$item->id}}" {{($item->id == $pl->bank_account) ? "SELECTED" : ""}}>{{$item->source}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                            ...
                            <tr>
                                <td align="center">
                                    <b>TAX</b>
                                    <form action="{{route('report.pl.update', 'tax')}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 mx-auto">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <input type="text" name="tax" class="form-control" value="{{(!empty($pl->tax)) ? $pl->tax : 0}}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="hidden" name="id_project" value="{{$pl->id}}">
                                                        <button type="submit" class="btn btn-xs btn-primary">save</button>
