                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h3>NO#     : {{ sprintf("%03d", $detail->id) }}/REIMBURSE/{{ \Session::get('company_tag') }}/{{ $mnth_array[date('n', strtotime($detail->input_date))] }}/{{ date('y', strtotime($detail->input_date)) }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    ...
                    <table class="table table-hover display font-size-sm" style="margin-top: 13px !important; width: 100%;" border="0">
                        ...
                        @foreach($typewo as $key => $val)
                            <tr {{(!isset($isReimburse[$val->id])) ? "class=print-hide" : ""}}>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right text-block">
                                                @if($detail->m_approve==null)
                                                    ...
                                                    <a href="{{route('reimburse.deleteDetail',['id' => $value->id,'id_cb' => $value->id_reimburse])}}" class="btn btn-danger btn-xs btn-PRIMARY print-hide" title="Delete" onclick="return confirm('Are you sure you want to delete ?')"><i class="fa fa-trash"></i></a>
                                                @endif
                                            </td>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label class="col-md-2 col-form-label text-right">Date</label>
                                                                            <div class="col-md-6">
                                                                                <input type="date" name="req_date" id="req_date" class="form-control" required value="{{$value->tanggal}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label class="col-md-2 col-form-label text-right">Subject</label>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label class="col-md-2 col-form-label text-right">Amount</label>
                                                                            <div class="col-md-6">
                                                                                <input type="text" class="form-control number" name="amount" required value="{{$value->cashout}}">
                                                                            </div>
