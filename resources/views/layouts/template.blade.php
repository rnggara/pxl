...
<head>
    ...
    <style>
        ...
        .card{
            background-color: rgba(39, 53, 74, .7);
            color: #fff;
        }

        .footer{
            background-color: rgba(39, 53, 74, 1);
            color: #fff;
        }
...
<body id="kt_body" class="header-fixed header-mobile-fixed page-loading-enabled">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <!--begin::Content-->
                ...
                <div class="content d-flex flex-column flex-column-fluid" style="background-image: url('images/bg.png'); background-color: #e6e6e6" id="kt_content">
                    <!--begin::Entry-->
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("span.menu-text").addClass('text-white')
