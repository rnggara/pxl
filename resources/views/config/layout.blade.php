...
<head>
    <meta charset="utf-8" />
    <title>Cypher Installation</title>
    ...
    <link href="{{asset('theme/assets/css/pages/wizard/wizard-3.css?v=7.0.5')}}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
    <div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
        <!--begin::Logo-->
        <a href="#">
            <img alt="Logo" src="{{asset('theme/assets/media/logos/logo-letter-9.png')}}" class="max-h-30px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
...
<script src="{{asset('theme/assets/js/pages/custom/wizard/wizard-3.js')}}"></script>
