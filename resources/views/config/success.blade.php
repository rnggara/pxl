...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url({{asset('assets/media/errors/bg1.jpg')}});">
        <!--begin::Content-->
        <h1 class="font-weight-boldest text-dark-75 mt-15" style="font-size: 10rem">Success!</h1>
        <p class="font-size-h3 text-muted font-weight-normal">This is your Administrator account.<br />Username : {{$user[0]->username}}<br />Password :
            cypher<br /><br /><a href='{{URL::route('login')}}'>Click here</a> to login</p>
        <!--end::Content-->
    </div>
    <!--end::Error-->
</div>
