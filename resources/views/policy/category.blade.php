                    ...
                    @foreach($categories as $key => $value)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('policy.category.delete', $value->id_category)}}" title="Delete" class="btn btn-sm btn-danger btn-icon btn-icon-md" onclick="return confirm('Delete category?')"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
