...
<table>
    <thead>
        <tr>
            <th width="50%"><center> <h4>INDONESIAN</h4> </center></th>
            <th width="50%"><center> <h4>ENGLISH</h4> </center></th>
        </tr>
        <br />
    </thead>
    <tbody>
    <tr>
        <td width="50%"><p class="ml-30">{!! $detail->content !!}</p></td>
        <td width="50%"><p class="ml-30">{!! $detail->content_eng !!}</p></td>
    </tr>
    </tbody>
</table>
<br><br><br>
