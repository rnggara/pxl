    ...
    <div class="modal fade" id="addDocument" tabindex="-1" role="dialog" aria-labelledby="addDocument" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('general.doc.add')}}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="file_upload[]" multiple id="file-input" required>
...
@section('custom_script')
    <script>
        function file_allowed(){
            ...
            if (sel === "document"){
                $("#file-input").attr('accept', '.jpg,.jpeg,.png')
        ...
        function delete_document(x){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('general.doc.delete')}}/"+x,
                        type: "get",
                        dataType: "json",
