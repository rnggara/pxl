    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                <h3>Safety Meeting</h3>
            </div>

            <div class="card-toolbar">
                <!--end::Button-->
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addItem"><i class="fa fa-plus"></i>Add Safety Meeting</button>
                </div>
            </div>
    ...
    <div class="modal fade" id="addItem" tabindex="-1" role="dialog" aria-labelledby="addItem" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <form method="post" id="form-add" action="{{route('sm.store')}}" enctype="multipart/form-data">
                    @csrf
