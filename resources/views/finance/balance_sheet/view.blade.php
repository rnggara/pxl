            ...
            @foreach($list_coa as $coa)
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-5">
                        <table class="table display table-responsive-xl" data-page-length="100" id="table-{{$coa->code}}">
                            <thead>
                                <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <div class="show-credit{{$coa->code}}{{$value['id']}}">
                                                    <span class="credit">{{number_format($value['debit'])}}</span>
                                                </div>
                                            ...
                                            <td align="right">
                                                <div class="show-debit{{$coa->code}}{{$value['id']}}">
                                                    <span class="debit">{{number_format($value['credit'])}}</span>
                                                </div>
