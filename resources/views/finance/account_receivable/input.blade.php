                    ...
                    <form action="{{route('ar.add_input')}}" method="POST" id="form-entry">
                        ...
                        <table class="table table-responsive-xl">
                            ...
                            <tr class="tr_clone">
                                ...
                                <td align="center">
                                    <input type="number" onkeyup="calc()" name="qty[]" class="form-control number qty" style="width: 50%" required>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <input type="text" onkeyup="calc()" name="price[]" class="form-control number price" style="width: 50%" required>
                                </td>
                                <td align="right">
    ...
    <script>
        ...
        function calc(){
            ...
            for (let i = 0; i < qty.length; i++) {
                var sum = parseFloat(qty[i].value) * parseFloat(price[i].value)
