                        ...
                        ?>
                            @for($i=1; $i <= $loan->period; $i++)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="percent[{{$i}}]" onchange="calc_3({{$i}})" class="form-control kt_inputmask_6 number" name="rate[{{$i}}]" value="{{$loan->bunga}}">
                                    </td>
                                    <td align="right">
                                        <input type="text" onchange="calc_cicilan({{$i}})" class="form-control kt_inputmask_6 input-cicilan number" id="bunga[{{$i}}]" name="interest[{{$i}}]" value="{{number_format($rate, 2)}}">
                                    </td>
                                    <td align="right">
