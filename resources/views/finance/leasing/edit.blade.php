                    ...
                    <table class="table display">
                        ...
                        @foreach($loan_item as $key => $value)
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <input type="text" {{$read}} id="cicilan[{{$value->id}}]" onchange="calc_1({{$value->id}})" class="form-control number {{$bg}} kt_inputmask_6" name="installment[{{$value->id}}]" value="{{$value->cicilan}}">
                                </td>
                                <td>
                                ...
                                <td align="right">
                                    <input type="text" {{$read}} onchange="_bunga(this, {{$value->id}})" class="form-control {{$bg}} number kt_inputmask_6" id="bunga[{{$value->id}}]" name="interest[{{$value->id}}]" value="{{number_format($value->bunga, 2)}}">
                                </td>
                                <td align="right">
                                    <input type="text" {{$read}} class="form-control number {{$bg}} kt_inputmask_6" id="total_bayar[{{$value->id}}]" readonly value="{{number_format($total_amount, 2)}}">
                                </td>
                                <td align="center">
                                    {{$value->status}}
                                </td>
...
@section('custom_script')
    ...
    <script>
        ...
        function calc_1(index){
            ...
            bunga.value  = $.number(newbunga.toFixed(2), 2)
            var newTotal = toNum(cicilan.value) + toNum(bunga.value)
            total.value = $.number(newTotal.toFixed(2), 2)
        }
        ...
        function calc_4(index){
            ...
            for (var i = index + 1; i <= {{$loan->period}}; i++) {
                ...
                i_bunga.value  = newbunga.toFixed(2)
                i_cicilan.value = i_cicilan.value
                var newTotal = toNum(i_cicilan.value) + toNum(i_bunga.value)
                i_total.value = newTotal.toFixed(2)
            }
        }
        ...
        $(document).ready(function(){
            ...
            $(".kt_inputmask_6").css('text-align', 'right')
        })
    </script>
@endsection
