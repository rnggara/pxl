...
- 20 Mar 2004 0.12
Fixed month calculation errors in adodb_date. 2102-June-01 appeared as 2102-May-32.
...
Gregorian correction handled. In PHP5, we might throw an errors if
...
function adodb_date_test_date($y1,$m,$d=13)
{
	...
	if ("$y1-$m-$d $h:00:00" != $rez) {
		print "<b>$y1 errors, expected=$y1-$m-$d $h:00:00, adodb=$rez</b><br>";
		return false;
	}
	return true;
}
...
function adodb_date_test_strftime($fmt)
{
	...
	echo "errors for $fmt,  strftime=$s1, adodb=$s2<br>";
	return false;
}
