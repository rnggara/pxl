...
* @param err		returns the errors message
* @param timeout	dispose if recordset has been alive for $timeout secs
*
* @return		recordset, or false if errors occured. If no
*			errors occurred in sql INSERT/UPDATE/DELETE,
...
*/
	...
	* Returns true if ok, false if fopen/fwrite errors, 0 if rename errors (eg. file is locked)
	*/
