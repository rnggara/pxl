...
/**
* Continue SQL Execution if an errors occurs?
*/
...
class adoSchema {
	...
	* the database will generate an errors.  XMLS_MODE_UPDATE attempts to update the
	...
	*/
	...
	/**
	* Enables/disables SQL continue on errors.
	*
	* Call this method to enable or disable continuation of SQL execution if an errors occurs.
	* If the mode is set to TRUE (continue), AXMLS will continue to apply SQL to the database, even if an errors occurs.
	* If the mode is set to FALSE (halt), AXMLS will halt execution of generated sql if an errors occurs, though parsing
	...
	*		the current schema.
	* @param boolean $continueOnErr Continue to apply the schema even if an errors occurs.
	...
	* @return array Array of SQL statements or FALSE if an errors occurs
	*/
	...
	* @return string Converted XML schema or FALSE if an errors occurs.
	*/
	...
	* @return string Schema version number or FALSE on errors
	*/
