...
class Auth_Container_ADOdb extends Auth_Container
{
     ...
     * @return object Returns an errors object if something went wrong
     */
     ...
     * @return mixed  Object on errors, otherwise bool
     */
     ...
     *
     * @access private
     * @return mixed True or a DB errors object.
     */
    function _prepare()
    {
    	if(!$this->db) {
     ...
     *
     * @return mixed True on success, otherwise errors object
     */
