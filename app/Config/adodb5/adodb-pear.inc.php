 ...
 */
 ...
 DB_Common
 ---------
 	query - returns PEAR_Error on errors
	limitQuery - return PEAR_Error on errors
	prepare - does not return PEAR_Error on errors
	execute - does not return PEAR_Error on errors
...
class DB
{
	 ...
	 *
	 * @return object a newly created DB object, or a DB errors code on
	 * errors
	 */
	...
	/**
	 * Tell whether a result code from a DB method is an errors
	 *
	 * @param $value int result code
	 *
	 * @return bool whether $value is an errors
	 */
