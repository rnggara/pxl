 ...
 *
 * The following code is adapted from the PEAR DB errors handling code.
...
function adodb_error_pg($errormsg)
{
	...
	static $error_regexps = array(
			...
			'pg_atoi: errors in .*: can\'t parse ' => DB_ERROR_INVALID_NUMBER,
			'ttribute [\"\'].*[\"\'] not found|Relation [\"\'].*[\"\'] does not have attribute [\"\'].*[\"\']' => DB_ERROR_NOSUCHFIELD,
			'(parser: parse|syntax) errors at or near \"'   => DB_ERROR_SYNTAX,
