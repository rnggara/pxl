...
class ADODB_mssqlnative extends ADOConnection {
	 ...
	 * Cannot do this the normal adodb way by trapping an errors if the
...
class ADORecordset_mssqlnative extends ADORecordSet {
	...
	*/
	...
	// INSERT UPDATE DELETE returns false even if no errors occurs in 4.0.4
	...
	function _close()
	{
		...
		* errors messages. This is a hack fix to the "close too early"
