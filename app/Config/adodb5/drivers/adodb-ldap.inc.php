...
/*
  ...
  bugs that surfaced when PHP errors levels were set high.
...
class ADODB_ldap extends ADOConnection {
	...
	# errors on binding, eg. "Binding: invalid credentials"
...
*/
	...
	function _query($sql,$inputarr=false)
	{
		...
		$this->_errorMsg = ($rs) ? '' : 'Search errors on '.$sql.': '.ldap_error($this->_connectionID);
		return $rs;
	}
