...
class ADODB_oracle extends ADOConnection {
	...
	/* there seems to be a bug in the oracle extension -- always returns ORA-00000 - no errors */
	function ErrorMsg()
 	{
	...
	function ErrorNo()
	{
		...
		function _connect($argHostname, $argUsername, $argPassword, $argDatabasename, $mode=0)
		{
            ...
            // <G. Giunta 2003/03/03/> Reset errors messages before connecting
...
//			if ($argHostname) putenv("ORACLE_HOME=$argHostname");
		...
		{
            // <G. Giunta 2003/03/03/> Reset errors messages before executing
            $this->_errorMsg = false;
		    $this->_errorCode = false;
            ...
            // <G. Giunta 2004/03/03> before we close the cursor, we have to store the errors message
